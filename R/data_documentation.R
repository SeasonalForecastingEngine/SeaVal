...
#'
#' This dataset contains observed monthly mean precipitation for October -
#' December 1981-2020. The unit of precipitation is mm/day. Only the greater
#' horn of Africa is covered. It also contains the tercile category, where -1
...
#'
#' This dataset contains hindcasts of the monthly mean precipitation for October
#' - December 1993-2020. The forecasts are issued by the ECMWF SEAS 5 model and
#' initialized in August. The unit of precipitation is mm/day. Only the greater
#' horn of Africa is covered, and only the first 5 ensemble members are
#' provided. The dataset also contains tercile probability forecasts, which are
#' derived from the full 25 member ensemble. The probability for a tercile for a
